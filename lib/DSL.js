(function (collections) {
    ...
    Transform.prototype.Controller = function (target, parent , rule) {
        ...
        for (elm of condiOperArr) {
            if (this.checkConditions(elm.conditions , target , parent)) {
                this.performOprs(elm.operations , target , parent)
            }
        }
    ...
    Transform.prototype.CondtionOperMapper  = function (condis){
    ...
    Transform.Getters = {
        ...
        "getReference" : function (main , target , parent) {
            ...
            const arr = getArrayOfPath(main.keyPara)
        ...
        "getConcatinate" : function (main , target , parent) {
            ...
            let resultStr = ""
            for (elm of arr ) {
                if (typeof elm == "object" && elm.hasOwnProperty("Getter")) {
                    resultStr = resultStr + main.__this.resolveGetter()
                }
                else {
